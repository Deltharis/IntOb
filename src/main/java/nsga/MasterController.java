...
public abstract class MasterController {
     ...
     * <p>
     * b) Wykorzystując selekcję turniejową z operatorem zatłoczenia crowded tournament selection operator, który omówiony zostanie poniżej,
     * a także osobników. operatory rekombinacji oraz mutacji utwórz populację potomną Q0 także o rozmiarze N.
     */
    protected void init() {
    ...
    /**
     * Utwórz populację Rt = Pt ∪Qt o rozmiarze 2N stanowiącą sumę populacji osobników rodzicielskich Pt oraz osobników potomnych Qt
     * <p>
     * a) Przeprowadź dla populacji Rt sortowanie osobników zgodnie z kolejnymi stopniami zdominowania tworząc w ten sposób kolejne fronty Fi gdzie
     * <p>
     * i = 1, 2, . . .
     */
    private void step1() {
     ...
     * do populacji Pt+1 trafia tylko tyle wybranych osobników z aktualnie przetwarzanego podzbioru (n-frontu) populacji Rt aby rozmiar populacji Pt+1 był równy N.
     */
    private List<Agent> step3() {
        List<Agent> front = sum.getNextFront();
    ...
    /**
     * Wykorzystując selekcję turniejową z operatorem zatłoczenia crowded tournament selection operator, a także operatory rekombinacji oraz mutacji w oparciu o populację Pt+1
